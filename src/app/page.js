    ...
    <div className="min-h-screen bg-landing-bg">
      ...
      <main className="max-w-2xl mx-auto px-8 pb-24">
        ...
        <p className="font-sans text-landing-secondary mb-16 leading-relaxed">
          Howdy, I&apos;m Aadit! I&apos;m studying Computer Science at Texas A&amp;M and enjoy building things for the web in my free time. I&apos;m currently interning at{' '}
          ...
          {' '}and I recently won the Capital One Challenge at TAMUhack!
        </p>
